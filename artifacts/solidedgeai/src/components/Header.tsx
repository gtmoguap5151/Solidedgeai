        ...
        <div className="flex items-center justify-between h-16">
          <button onClick={() => onNavigate('home')} className="flex items-center gap-2 group">
            ...
            <div className="text-left leading-tight">
              ...
              <div className="text-stone-500 text-xs hidden sm:block">AI that earns its place</div>
            </div>
          </button>
          ...
          <nav className="flex items-center gap-2 sm:gap-4">
            ...
            <button
              ...
              className={`inline-flex items-center gap-1.5 text-sm font-semibold px-3 py-2 rounded-lg transition-colors ${
                currentPage === 'assessment' ? 'bg-amber-100 text-amber-800' : 'text-stone-700 hover:bg-stone-100'
              }`}
            >
